      ...
      <div class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
        ...
        <div class="bg-white relative invisible md:visible flex flex-wrap py-6 rounded shadow-md">
          <div class="lg:w-1/2 px-6">
            <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">{{ __('messages.addr') }}</h2>
      ...
      <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
        ...
        <form wire:submit="send2Line" >
            ...
            <div class="relative mb-4">
                <label for="name" class="leading-7 text-sm text-gray-600">{{ __('messages.fname') }}<span class="text-red-500">*</span></label>
            ...
            <div class="relative mb-4">
                <label for="email" class="leading-7 text-sm text-gray-600">{{ __('messages.email') }}<span class="text-red-500">*</span></label>
            ...
            <div class="relative mb-4">
                <label for="phone" class="leading-7 text-sm text-gray-600">{{ __('messages.phone') }}<span class="text-red-500">*</span></label>
            ...
            <div class="relative mb-4">
                ...
                <input wire:model="social" maxlength="200" placeholder="{{ __('messages.sub_social') }}" type="text" id="social" name="social" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
            </div>
            ...
            <div class="relative mb-4">
                <label for="social" class="leading-7 text-sm text-gray-600">{{ __('messages.ent_res') }}<span class="text-red-500">*</span>:</label>
                <input wire:model="captcha" required maxlength="200" type="text" placeholder="{{ __('messages.ent_pls') }}" id="captcha" name="captcha" class="w-full bg-white rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
            ...
            <div class="flex items-center">
                <button type="submit" class="text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">{{ __('messages.subm') }}</button>
