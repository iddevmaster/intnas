...
@section('content')
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light">Main / Promotion /</span> Add Promotion
</h4>
    ...
    <div class="card-body">
        <form action="{{ route('store-promotion') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" required maxlength="500" name="promo_title" id="defaultFormControlInput" placeholder="Promotion title" aria-describedby="defaultFormControlHelp" />
            </div>
            ...
            <div class="mb-5">
                ...
                <textarea id="prodetail" name="promo_desc" placeholder="Promotion Detail"></textarea>
            </div>
